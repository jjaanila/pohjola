...
to Pohjola as an experiment. After kalevans inhabitated Pohjola, Väinämöinen imprisoned Perkele into a jail on the bottom of Lake Sotkalampi (old name Lake Iänlampi).`,
    ...
    },
    {
      ...
      armorClass: 17,
      armor: 'natural armor',
      hitPoints: { throws: 11, sides: 12, constant: 55 },
      speedFt: 40,
      strength: 23,
      dexterity: 15,
      constitution: 20,
      ...
      wisdom: 12,
      charisma: 9,
      savingThrows: ['Dex +5', 'Con +8', 'Wis +8'],
      senses: [{ name: 'darkvision', value: 60 }],
      skills: [
      ...
      passives: [
        {
          name: 'Stone Camouflage',
          description: 'Suur-Äijö has advantage on Dexterity (Stealth) checks made to hide in rocky terrain.',
        },
      ],
      actions: [
        {
          name: 'Multiattack',
          description: 'Suur-Äijö makes two greatclub attacks.',
        },
        {
          name: 'Greatclub',
          type: 'melee',
        ...
        },
        {
          ...
          reachFt: 60,
          rangeFt: 60,
          disadvantageRangeFt: 240,
          damageType: 'bludgeoning',
          damage: { throws: 4, sides: 10, constant: 6 },
          extra:
      ...
      reactions: [
        {
          name: 'Rock Catching',
          description:
            'If a rock or similar object is hurled at Suur-Äijö, Suur-Äijö can, with a successful DC 10 Dexterity saving throw, catch the missile and take no bludgeoning damage from it.',
        },
      ],
    },
    {
